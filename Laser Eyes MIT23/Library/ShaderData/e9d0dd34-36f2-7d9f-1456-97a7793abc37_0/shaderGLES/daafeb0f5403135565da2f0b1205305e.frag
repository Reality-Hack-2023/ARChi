...
vec3 SamplerEncodedPanoramic(mediump sampler2D panoramic, vec3 dir, float rotation, float lod)
{
    ...
    vec2 _1292 = GetPanoramicTexCoordsFromDir(param, param_1);
    vec2 uv = _1292;
    vec2 param_2 = uv;
    float param_3 = lod;
...
vec4 ApplyBlendMode(vec4 color, vec2 uv)
{
    ...
    float param_3 = ret.w;
    vec3 _300 = BlendScreen(param_1, param_2, param_3);
    ret = vec4(_300.x, _300.y, _300.z, ret.w);
    return ret;
}
...
void main()
{
    ...
    vec3 subsurfaceCol;
    vec3 param_13 = subsurfaceCol;
    vec3 subsurfaceColMultiply;
    vec3 param_14 = subsurfaceColMultiply;
    float ior;
    float param_15 = ior;
    float transmittance;
    ...
    float param_25 = rim;
    vec3 rimCol;
    vec3 param_26 = rimCol;
    vec3 ambient;
    vec3 param_27 = ambient;
    vec3 matcap;
    vec3 param_28 = matcap;
    float smoothFactor;
    float param_29 = smoothFactor;
    vec4 finalColor = MainEntry(_AmbientTexture, param_2, param_3, param_4, param_5, param_6, param_7, param_8, param_9, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29);
    vec2 ndc_coord = v_gl_pos.xy / vec2(v_gl_pos.w);
    vec2 screen_coord = (ndc_coord * 0.5) + vec2(0.5);
    vec4 param_30 = finalColor;
    vec2 param_31 = screen_coord;
    glResult = ApplyBlendMode(param_30, param_31);
}

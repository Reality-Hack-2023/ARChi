...
vec3 DecodeNormal(inout vec3 normalTS, float normalIntensity)
{
    ...
    vec3 _273 = NormalIntensity(param, param_1);
    normalTS = _273;
...
vec3 SamplerEncodedPanoramic(mediump sampler2D panoramic, vec3 dir, float rotation, float lod)
{
    ...
    vec2 _1278 = GetPanoramicTexCoordsFromDir(param, param_1);
    vec2 uv = _1278;
    vec2 param_2 = uv;
    float param_3 = lod;
...
void main()
{
    ...
    vec3 _2201 = DecodeNormal(param_8, param_9);

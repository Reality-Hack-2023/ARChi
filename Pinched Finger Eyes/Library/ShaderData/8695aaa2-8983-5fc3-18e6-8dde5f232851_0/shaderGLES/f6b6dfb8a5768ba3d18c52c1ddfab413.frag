...
vec3 InverseNormalY(inout vec3 normal)
{
...
{
    vec3 param = normalTS;
    vec3 _282 = InverseNormalY(param);
    normalTS = _282;
    vec3 param_1 = normalTS;
    float param_2 = normalIntensity;
    vec3 _287 = NormalIntensity(param_1, param_2);
    normalTS = _287;
...
vec3 SamplerEncodedPanoramic(mediump sampler2D panoramic, vec3 dir, float rotation, float lod)
{
    ...
    vec2 _1291 = GetPanoramicTexCoordsFromDir(param, param_1);
    vec2 uv = _1291;
    vec2 param_2 = uv;
    float param_3 = lod;
...
void main()
{
    ...
    vec3 subsurfaceCol;
    vec3 param_21 = subsurfaceCol;
    vec3 subsurfaceColMultiply;
    vec3 param_22 = subsurfaceColMultiply;
    float ior;
    float param_23 = ior;
    float transmittance;
    ...
    float param_33 = rim;
    vec3 rimCol;
    vec3 param_34 = rimCol;
    vec3 ambient;
    vec3 param_35 = ambient;
    vec3 matcap;
    vec3 param_36 = matcap;
    float smoothFactor;
    float param_37 = smoothFactor;
    vec4 finalColor = MainEntry(_AmbientTexture, param_10, param_11, param_12, param_13, param_14, param_15, param_16, param_17, param_18, param_19, param_20, param_21, param_22, param_23, param_24, param_25, param_26, param_27, param_28, param_29, param_30, param_31, param_32, param_33, param_34, param_35, param_36, param_37);
    vec4 proj_pos = u_VP * vec4(v_posWS, 1.0);
    vec2 ndc_coord = proj_pos.xy / vec2(proj_pos.w);
    vec2 screen_coord = (ndc_coord * 0.5) + vec2(0.5);
    vec4 param_38 = finalColor;
    vec2 param_39 = screen_coord;
    glResult = ApplyBlendMode(param_38, param_39);
}

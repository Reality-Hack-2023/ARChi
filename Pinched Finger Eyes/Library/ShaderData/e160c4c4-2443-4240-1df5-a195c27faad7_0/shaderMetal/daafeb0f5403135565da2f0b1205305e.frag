...
fragment main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer, texture2d<float> u_DirLight0ShadowTexture [[texture(0)]], texture2d<float> u_SpotLight0ShadowTexture [[texture(1)]], texturecube<float> u_PointLight0ShadowTexture [[texture(2)]], texture2d<float> _EmissiveTexture [[texture(3)]], sampler u_DirLight0ShadowTextureSmplr [[sampler(0)]], sampler u_SpotLight0ShadowTextureSmplr [[sampler(1)]], sampler u_PointLight0ShadowTextureSmplr [[sampler(2)]], sampler _EmissiveTextureSmplr [[sampler(3)]])
{
    main0_out out = {};
    float2 uv = in.v_uv0;

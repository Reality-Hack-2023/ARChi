...
fragment main0_out main0(main0_in in [[stage_in]], constant buffer_t& buffer, texture2d<float> _OpacityTexture [[texture(0)]], texture2d<float> _AmbientTexture [[texture(1)]], sampler _OpacityTextureSmplr [[sampler(0)]], sampler _AmbientTextureSmplr [[sampler(1)]])
{
    main0_out out = {};
    float2 uv0 = in.v_uv0;
    ...
    float4 t_OpacityTex = _OpacityTexture.sample(_OpacityTextureSmplr, uv0);
    opacity *= t_OpacityTex.x;
